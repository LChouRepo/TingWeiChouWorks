...
class DBSCAN():
	...
	def expand(self, sample, neighbors):
        ...
        input sample and neighbor, outputs the cluster with sample & neighbors in it.
		"""
		cluster = set([sample])
	...
	def get_neigs(self, sample):
        ...
        input sample, outputs array of neighbors
		"""
	...
	def get_labels(self):
        ...
        outputs the label of each cluster
		"""
	...
	def predict(self, X):
        ...
        inputs database, outputs the predicted clustering labels.
		"""
		self.X = X
		self.clusters = {}
		self.visited = []
...
filepath = "CreditCard_User_Data.csv"
